...
class QrCode
{
	 ...
	 * @return string
	 */
	public static function getImagePath($strData, $intSize=200, $strEcc='L', $intMargin=1, $intQzone=4, $strColor=null, $strBgColor=null, $strFormat='png')
	{
		return static::buildRequestUrl($strData, $intSize, $strEcc, $intMargin, $intQzone, $strColor, $strBgColor, $strFormat);
	}
	 ...
	 * @return string
	 */
	public static function getLocalPath($strData, $blnPermanentSave=false, $intSize=200, $strEcc='L', $intMargin=1, $intQzone=4, $strColor=null, $strBgColor=null, $strFormat='png')
	{
		...
		$objRequest->send(static::API_URL, static::buildRequestUrl($strData, $intSize, $strEcc, $intMargin, $intQzone, $strColor, $strBgColor, $strFormat), 'POST');
	 ...
	 * @return string
	 */
	protected static function buildRequestUrl($strData, $intSize=200, $strEcc='L', $intMargin=1, $intQzone=4, $strColor=null, $strBgColor=null, $strFormat='png')
	{
		$arrParams = array
		(
